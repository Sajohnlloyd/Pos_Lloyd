...
if (isset($_POST['btn_login'])) {
    ...
    if ($row) {
        ...
        if (password_verify($password, $row['userpassword'])) {
            ...
            if ($row['role'] == "Admin") {
                $_SESSION['status'] = "Login Success as Admin";
                $_SESSION['status_code'] = "success";
                echo '<meta http-equiv="refresh" content="2;url=ui/dashboard.php">';
            } elseif ($row['role'] == "User") {
                $_SESSION['status'] = "Login Success as User";
                $_SESSION['status_code'] = "success";
                echo '<meta http-equiv="refresh" content="2;url=ui/user.php">';
            }
      ...
      <form action="" method="post">
        ...
        <div class="row">
          <div class="col-8">
            ...
            <a href="ui/signup.php">I don't have an account</a>
          </div>
          <div class="col-4">
